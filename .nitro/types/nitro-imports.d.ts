declare global {
  ...
  const forwardToBackend: typeof import('../../server/utils/backend').forwardToBackend
  ...
  const mockHomeData: typeof import('../../server/utils/mock').mockHomeData
  const mockSearchData: typeof import('../../server/utils/mock').mockSearchData
  const mockSourcesData: typeof import('../../server/utils/mock').mockSourcesData
...
export { forwardToBackend } from 'C:/Users/Pracheer/Desktop/pstream-pracheer/proxy/server/utils/backend';
export { mockHomeData, mockSearchData, mockSourcesData } from 'C:/Users/Pracheer/Desktop/pstream-pracheer/proxy/server/utils/mock';